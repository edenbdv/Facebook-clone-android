...
public final class MenuBinding implements ViewBinding {
  ...
  private MenuBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout menuLayout) {
  ...
  public static MenuBinding bind(@NonNull View rootView) {
    ...
    LinearLayout menuLayout = (LinearLayout) rootView;

    return new MenuBinding((LinearLayout) rootView, menuLayout);
  }
}
